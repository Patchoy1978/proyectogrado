...
class IngresoCargos():
    ...
    def ingreso_datos(self):
        ...
        campos2 = [
            ...
            {'label': 'Ingresar', 'ancho': 100, 'alto': 30, 'color':'#00155c', 'command': self.insertar_cargo},
            {'label': 'Eliminar', 'ancho': 100, 'alto': 30, 'color':'#00155c', 'command': self.eliminar_cargo},
            {'label': 'Modificar', 'ancho': 100, 'alto': 30, 'color':'#00155c', 'command': self.modificar_cargo},
