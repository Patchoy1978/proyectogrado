...
class PanelPrincipalVisualizacion():
    ...
    def __init__(self, frame_sup, frame, parent_window=None):
    ...
    def visual_principal_titulo(self):
        ...
        campos1 =[
            ...
            {"label": "Diferidos", "color": "#00155C", "tipo": "boton", "ancho": 26, "alto":30, "command": lambda: self.ver_pacientes_diferidos(), 'image' : None},
            {"label": "Realizados", "color": "#00155C", "tipo": "boton", "ancho": 26, "alto":30, "command": lambda: (self.ver_pacientes_realizados()), 'image' : None},
    ...
    def visual_principal_datos(self):
        ...
        for fila_paciente, paciente in enumerate(pacientes_filtrados):
            ...
            campos = [
                ...
                {"label": "Ubicación\nPaciente", "columna": "ubicacion", "valor": paciente.get("ubicacion", ""), "ancho": 130, "tipo": "entry"},
                ...
                {"label": "Hora\nCitación\nEstudio", "columna": "hora citacion estudio", "valor": paciente.get("hora_citacion", ""), "ancho": 85, "tipo": "entry"},
    ...
    def actualizar_pantalla(self):
        ...
        self.after_id_aviso = self.ventana.after(600000, self.actualizar_pantalla)
    ...
    def ver_pacientes_diferidos(self):
        ...
        try:
            from abrirventanas.abrir import abrir_ventana_visualizar_datos_ppal_diferidos

            # 🔹 Ocultamos la ventana principal (no la minimizamos)
            self.ventana.withdraw()

            # 🔹 Abrimos la ventana de diferidos, pasándole la principal
            abrir_ventana_visualizar_datos_ppal_diferidos(parent_window=self.ventana)

        except Exception as e:
            print(f"Error al abrir la ventana de diferidos: {e}")
    ...
    def ver_pacientes_realizados(self):
        ...
        try:
            ...
            # 🔹 Abrimos la ventana de diferidos, pasándole la principal
            abrir_ventana_visualizar_datos_ppal_realizados(parent_window=self.ventana)
    ...
    def aviso_tecnologo(self):
        ...
        if not self.db.conexion.is_connected():
            try:
                ...
                self.after_id_aviso = self.ventana.after(450000, self.aviso_tecnologo)
                return
    ...
    def salir(self):
        ...
        # Cancelar aviso_tecnologo si está activo
        try:
            if hasattr(self, 'after_id_aviso'):
                self.ventana.after_cancel(self.after_id_aviso)
        except Exception as e:
            print("Error cancelando after:", e)
