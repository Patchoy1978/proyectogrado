...
class PacientesModificar():
    ...
    def llenado_pacientes(self):
        ...
        for clave, widget in mapping.items():
            ...
            # para los combobox
                ...
                print("el resultado de la identificacion la hora es ", resultado)
    ...
    def cambio_diferido_a_pendiente(self, *_):
        ...
        if estado != 'Diferido':
            ...
            self.var_diferido.set(2)
        
        elif estado == 'Diferido':
            
            self.var_diferido.set(1)
    ...
    def modificar_datos(self):
        ...
        valores1 = (nombre, identificacion, edad, id_rango, fecha_orden, fecha_cita, hc,
