...
class PanelPrincipalVisualizacionDiferidos():
    ...
    def visual_principal_titulo(self):
        ...
        campos = [
            ...
            {"label": "Visualizacion De Pacientes Diferidos", "valor": "", "ancho": 400, "tipo": "label"},
    ...
    def visual_principal_datos(self):
        ...
        for fila_paciente, paciente in enumerate(pacientes_filtrados):
            ...
            campos2 = [
                ...
                {"label": "Modificar", "color": "lightblue", "tipo": "boton", "ancho": 70, "alto":50, "command": lambda p=paciente: self.abrir_y_guardar(p), 'image' : None},
