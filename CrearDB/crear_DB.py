...
class ConexionDB():
    ...
    def __init__(self, host, user, password, port):
        ...
        # Tablas principales
        # ------------------------
        # Todas las tablas que representan registros de pacientes
        tablas_principales = [
            "registrosPacientes",
        ...
        # Definición común para tablas principales
        sql_principal = {}
        ...
        relaciones = ["retrasos", "sedes", "modalidades", "estados", "usuarios"]
        ...
        for tabla, sql in sql_principal.items():
            ...
            for rel in relaciones:
                ...
                # SQL para crear tabla de relación
                sql_rel = f"""
